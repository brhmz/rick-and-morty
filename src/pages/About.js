...
function About() {
  ...
  return (
    <div className={!darkMode ? 'about' : 'about about-dark'}>
      <img className='about-banner' src='https://rickandmorty-mimo.netlify.app/static/media/banner.efe0a3d301782e438d4d.jpeg' />
      <h2>About Us</h2>
